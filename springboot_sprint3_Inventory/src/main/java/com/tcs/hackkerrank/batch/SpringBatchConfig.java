...
public class SpringBatchConfig {
    ...
    public Job job(JobBuilderFactory jobBuilderFactory,
                   ...
                   ItemReader<Inventory> itemReader,
                   ItemProcessor<Inventory, Inventory> itemProcessor,
                   ItemWriter<Inventory> itemWriter
    ) {

        Step step = stepBuilderFactory.get("ETL-file-load")
                .<Inventory, Inventory>chunk(100)
                .reader(itemReader)
    ...
    @Bean
    public FlatFileItemReader<Inventory> itemReader(@Value("${input}") Resource resource) {
    ...
    public LineMapper<Inventory> lineMapper() {
        ...
        lineTokenizer.setNames(new String[]{"skuId","productName","inventoryOnHand","productLabel","minQtyReq","price"});
